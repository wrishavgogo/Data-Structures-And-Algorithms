question : Premium 
Link : https://leetcode.com/problems/winner-of-the-linked-list-game/description/?envType=problem-list-v2&envId=linked-list
...
class Solution {
    public String gameResult(ListNode head) {
        ...
        // since its already given that list side is even
